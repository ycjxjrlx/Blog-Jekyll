...
jQuery(document).ready(function ($) {
    $("#spig").mousedown(function (e) {
        if(e.which==3){
        showMessage("秘密通道:<br />    <br/><a href=\"http://sanzhixiaozhu.top/\" title=\"雲木，幸会\">雲木，幸会</a>  ",10000);
}
});
...
jQuery(document).ready(function ($) {
    if (isindex) { //如果是主页
        ...
        if (now > 0 && now <= 6) {
            ...
            showMessage(visitor + ' 快来陪我玩吧！', 6000);
        }
    }
    else {
...
jQuery(document).ready(function ($) {
    ...
    window.setInterval(function () {
        msgs = [ "陪我聊天吧！", "好无聊哦，你都不陪我玩！","说悄悄话不会被听见吧", "…@……!………", "我也会偷偷跑出去玩，嘘~","我不在不要打小报告！","(￢_￢)瞄", "(ﾉﾟ▽ﾟ)ﾉ","我可爱吧！~^_^!~","是谁?~送你来到我身边~~","从前有座山，山上有座庙，庙里有个老和尚给小和尚讲故事，讲：“从前有座……”","姐姐不用管手机，好羡慕","来换班啦","什么！你喜欢姐姐，我要告诉她","手机端看不到姐姐，啦啦啦啦","我也喜欢姐姐"];
        var i = Math.floor(Math.random() * msgs.length);
...
jQuery(document).ready(function ($) {
    ...
    $(".mumu").click(function () {
            ...
            if (stat_click > 4) {
                ...
                msgs = ["如果打扰到你阅读，刷新页面我可能就不在咯……","筋斗云！~我飞！", "我跑呀跑呀跑！~~","如果打扰到你阅读，刷新页面我就……", "别摸我，会生气的！","下次刷新页面我不出来了！哼！", "惹不起你，我还躲不起你么？", "不要摸我了，我会告诉老婆来打你的！", "干嘛动我呀！小心我咬你！","我也会偷偷跑出去玩，嘘~","我不在不许打小报告！","姐姐不用管手机，好羡慕","来换班啦","什么！你喜欢姐姐，我要告诉她","手机端见不到姐姐，啦啦啦啦","我也喜欢姐姐","什么！你喜欢姐姐，我要告诉她"];
                var i = Math.floor(Math.random() * msgs.length);
                showMessage(msgs[i]);
            }
