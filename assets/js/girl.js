...
jQuery(document).ready(function ($) {
    ...
    window.setInterval(function () {
        msgs = [ "陪我聊天吧！","说悄悄话不会被听见吧", "…@……!………", "我也会偷偷跑出去玩，嘘~","我不在不要打小报告！","(￢_￢)瞄", "(ﾉﾟ▽ﾟ)ﾉ","我可爱吧！~^_^!~","是谁?~送你来到我身边~~","从前有座山，山上有座庙，庙里有个老和尚给小和尚讲故事，讲：“从前有座……”","姐姐不用管手机，好羡慕","来换班啦","什么！你喜欢姐姐，我要告诉她","手机端看不到姐姐，啦啦啦啦","我也喜欢姐姐"];
        var i = Math.floor(Math.random() * msgs.length);
