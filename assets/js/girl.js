...
jQuery(document).ready(function ($) {
    ...
    window.setInterval(function () {
        msgs = [ "陪我聊天吧！","说悄悄话不会被听见吧", "…@……!………", "我也会偷偷跑出去玩，嘘~","我不在不要打小报告！","(￢_￢)瞄", "(ﾉﾟ▽ﾟ)ﾉ","我可爱吧！~^_^!~","是谁?~送你来到我身边~~","从前有座山，山上有座庙，庙里有个老和尚给小和尚讲故事，讲：“从前有座……”","来换班啦","什么！你喜欢姐姐，我要告诉她","我也喜欢姐姐","小秘密：姐姐有个bug","大家都很努力呢"];
        var i = Math.floor(Math.random() * msgs.length);
...
jQuery(document).ready(function ($) {
    ...
    $(".mumu").click(function () {
            ...
            if (stat_click > 6) {
                ...
                msgs = ["筋斗云！~我飞！", "我跑呀跑呀跑！~~","别摸我，会生气的！","下次刷新页面我不出来了！哼！", "惹不起你，我还躲不起你么？", "不要摸我了，我会告诉老婆来打你的！", "干嘛动我呀！小心我咬你！","我也会偷偷跑出去玩，嘘~","我不在不许打小报告！","来换班啦","什么！你喜欢姐姐，我要告诉她","我也喜欢姐姐","什么！你喜欢姐姐，我要告诉她","我和姐姐轮班"];
                var i = Math.floor(Math.random() * msgs.length);
                //showMessage(msgs[i]);
            }
